    ...
    <div>
        ...
        <v-sheet :elevation="6" class="pa-2 primary">
            ...
            <span  class=" headline white--text font-weight-light">
                Você pode carregar e salvar os dados</span>
        </v-sheet>
        <v-sheet :elevation="6" class="pa-2 green darken-1 mt-3">
            <v-icon class="white--text mr-3">info</v-icon>
            <span  class=" headline white--text font-weight-light">
                Clique em 'Finalizar Dia' para finalizar para iniciar um novo dia!
            </span>
        </v-sheet>
